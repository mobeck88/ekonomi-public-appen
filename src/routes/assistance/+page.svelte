    ...
    <tbody>
        ...
        {#if correctionIncome}
            <tr class="bg-yellow-50">
                ...
                {#each correctionIncome.values as v, i}
                    <td class="border p-2">
                        <form method="POST" action="/assistance/updateCorrection">
                            <input type="hidden" name="type" value="income" />
                            <input type="hidden" name="month" value={months[i]} />
                            <input
                                type="number"
                                name="value"
        ...
        {#if correctionExpense}
            <tr class="bg-yellow-50">
                ...
                {#each correctionExpense.values as v, i}
                    <td class="border p-2">
                        <form method="POST" action="/assistance/updateCorrection">
